...
public class BaseExceptionHandler {
    ...
    @ExceptionHandler(value = AchuiException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public AchuiResponse handleFebsException(AchuiResponse e) {
        log.error("系统错误", e);
        return new AchuiResponse().message(e.getMessage());
    }
     ...
     * @return AchuiResponse
     */
    @ExceptionHandler(value = ConstraintViolationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public AchuiResponse handleConstraintViolationException(ConstraintViolationException e) {
        ...
        return new AchuiResponse().message(message.toString());
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public AchuiResponse handleBindException(BindException e) {
        StringBuilder message = new StringBuilder();
