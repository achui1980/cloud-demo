package com.achui.gateway.handler;
...
/**
 * @author portz
 * @date 2020/4/30 21:47
 */
@Slf4j
public class AchuiGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {
    public AchuiGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
