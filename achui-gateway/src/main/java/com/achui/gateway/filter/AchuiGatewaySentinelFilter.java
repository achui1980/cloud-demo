...
import com.achui.gateway.fallback.AchuiGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class AchuiGatewaySentinelFilter {
    @Bean
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new AchuiGatewayBlockFallbackProvider());
        initGatewayRules();
    }
